                ...
                <div class="card-body">
                  <form action="{{ route('penyakit.update', $get_penyakit->id) }}" method="post">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" name="kode" class="form-control @error('kode') is-invalid @enderror" id="kode" value="{{ $get_penyakit->kode }}" readonly>
                      @error('kode') <div class="form-control-feedback text-danger">{{ $message }}</div> @enderror
                    </div>
                    <div class="mb-3">
                      <label for="nama" class="form-label">Nama</label>
                      <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" id="nama" value="{{ old('nama', $get_penyakit->nama) }}">
